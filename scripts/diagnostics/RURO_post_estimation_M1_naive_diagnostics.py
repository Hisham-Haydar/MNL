...
See docs/RURO_post_estimation_M1_naive_diagnostics_implementation_report_v1.md.
...
def write_report(
    ...
    L += [
        ...
        "*Research-only: see `docs/RURO_post_estimation_M1_naive_diagnostics_implementation_report_v1.md`*",
    ]
