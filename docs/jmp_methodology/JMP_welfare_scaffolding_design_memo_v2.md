...
- `docs/jmp_methodology/JMP_multi_year_and_cross_validation_strategy_memo_v3_1.md`
  ...
  elements I3 and I6).
- `docs/France_case/P3a/execution_logs/single_year_baseline/M1/RURO_occ_M1_naive_robustness_verdict_v1.md` §17 (the
  authorising verdict for the audit).
- `docs/France_case/P3a/execution_logs/single_year_baseline/M1/RURO_occ_M1_clean_verdict_v1.md` (the SA1-STANDS reference
...
- `docs/JMP_welfare_measurement_decisions_memo_v1.md` (the locked
  welfare-measurement decisions).
- `docs/France_case/P3a/execution_logs/single_year_baseline/M1/RURO_occ_M1_clean_verdict_v1.md` (the SA1-STANDS baseline)
