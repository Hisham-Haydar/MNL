...
| html_report | U:\Desktop\Nizam_Hisham\MNL\outputs\post_estimation\fr\spec\stijn_occ\gamspy\estimation_spec_stijn_occ_M0\run_2026-05-13_14-25-39\fr_2016_stijn_occ_gamspy_post_estimation_report_20260513_142601.html |
| post_output_dir | U:\Desktop\Nizam_Hisham\MNL\outputs\post_estimation\fr\spec\stijn_occ\gamspy\estimation_spec_stijn_occ_M0\run_2026-05-13_14-25-39 |
| params_csv | U:\Desktop\Nizam_Hisham\MNL\outputs\post_estimation\fr\spec\stijn_occ\gamspy\estimation_spec_stijn_occ_M0\run_2026-05-13_14-25-39\fr_2016_stijn_occ_gamspy_params.csv |
| elasticities_csv | U:\Desktop\Nizam_Hisham\MNL\outputs\post_estimation\fr\spec\stijn_occ\gamspy\estimation_spec_stijn_occ_M0\run_2026-05-13_14-25-39\fr_2016_stijn_occ_gamspy_elasticities.csv |
...
| type | message |
| --- | --- |
| identification | ill-conditioned (κ ≥ 1e10); 2 negative eigenvalue(s) — not at a local maximum or numerically singular |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| joint | 1 | SolveStatus.NormalCompletion (ModelStatus.OptimalLocal) | 29 | 29 | NA | -6499.88 | 100.306 |
...
_Interpretation: ill-conditioned (κ ≥ 1e10); 2 negative eigenvalue(s) — not at a local maximum or numerically singular._

## Initial → Final Movement (top 15 by |Δ|)

| block | parameter | initial_value | final_estimate | delta |
| --- | --- | --- | --- | --- |
| preference | joint.beta_l0_sf | 1 | 5.75853 | 4.75853 |
| preference | joint.beta_l0_f | 1 | 5.69717 | 4.69717 |
| preference | joint.beta_c | 1 | 5.26199 | 4.26199 |
| preference | joint.beta_l0_sm | 1 | 4.46662 | 3.46662 |
| employment_hours_opportunity | joint.beta_E | 0 | -2.6148 | -2.6148 |
| preference | joint.beta_l_educH_sf | 0 | -2.27103 | -2.27103 |
| occupation_opportunity | joint.beta_occ_3_cm | 0 | -2.20606 | -2.20606 |
| occupation_opportunity | joint.beta_occ_3_sm | 0 | -2.17256 | -2.17256 |
| preference | joint.beta_l0_m | 1 | 2.70226 | 1.70226 |
| occupation_opportunity | joint.beta_occ_2_sm | 0 | -1.51286 | -1.51286 |
| preference | joint.beta_l_educH_f | 0 | -1.48897 | -1.48897 |
| occupation_opportunity | joint.beta_occ_2_cm | 0 | -1.47074 | -1.47074 |
| employment_hours_opportunity | joint.beta_h_ft | 0 | 1.46325 | 1.46325 |
| preference | joint.beta_l_educH_sm | 0 | -1.30348 | -1.30348 |
| preference | joint.theta_c | -1 | 0.215302 | 1.2153 |
