...
**Authorization:** `docs/JMP_GSUR_year_alignment_decision_v1.md` (Decision 1)  
...
by `docs/JMP_GSUR_year_alignment_decision_v1.md` Decision 1 and required by the
...
combinations. See `docs/RURO_prep_mnl_gsur_year_support_report_v1.md` §6.
...
rebuild, per `docs/RURO_prep_mnl_gsur_year_support_report_v1.md`. Three edits were
applied:
...
and Decision 4 of `docs/JMP_GSUR_year_alignment_decision_v1.md`. They may be used
