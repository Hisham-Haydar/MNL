# Stijn's R Implementation vs Python Implementation Comparison

**Date:** 2025-12-16
**Purpose:** Verify Python implementation matches Stijn's R specification

---

## Wage Opportunity Specification (from Stijn's R code)
...
## Hours Opportunity Specification (from Stijn's R code)
...
**Stijn's R**: param[81] and param[82] appear in BOTH male and female equations
**Python**: Need to verify if year dummies are shared or separate

### Issue 2: Is GSUR in Wage Opportunity?
**Stijn's R**: GSUR is ONLY in hours opportunity (`hopp`), NOT in wage opportunity (`wopp`)
...
### Stijn's R Implementation (variable wages, "vw"):
...
**Note**: In Stijn's code, param indices start at 1 (R convention)

### Python Implementation (RURO_estimate_FR.py)

**Expected: 60-62 parameters** (depending on year dummies)

Wait - this is DIFFERENT from Stijn's 82 parameters! Let me check what's different...
...
**Status:** Understanding Stijn's specification complete. Need to verify Python implementation matches.
