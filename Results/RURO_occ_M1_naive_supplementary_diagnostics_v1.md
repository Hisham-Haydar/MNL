...
Implementation report: `docs/RURO_post_estimation_M1_naive_diagnostics_implementation_report_v1.md`
...
*Evidence only — no verdict. See `docs/RURO_post_estimation_M1_naive_diagnostics_implementation_report_v1.md` for implementation notes.*
