...
| Original | Mirror |
| --- | --- |
| `Data/documentation/euromod_fr_2015_2017_input_output_reference.md` | `docs/France_case/euromod_reference/euromod_fr_2015_2017_input_output_reference.md` |
...
| `Data/documentation/FR_2015_index.md` | `docs/France_case/euromod_reference/FR_2015_index.md` |
| `Data/documentation/FR_2015_all_tables_compact.md` | `docs/France_case/euromod_reference/FR_2015_all_tables_compact.md` |
| `Data/documentation/FR_2015_index.jsonl` | `docs/France_case/euromod_reference/FR_2015_index.jsonl` |
...
| Original | Mirror |
| --- | --- |
| `Results/RURO_ruro_occ_M0_rebuild_canary_report_v1.md` | `docs/France_case/canary_reports/RURO_ruro_occ_M0_rebuild_canary_report_v1.md` |

## Job-Choice Documentation Mirrors

| Original | Mirror |
| --- | --- |
| `scripts/Job_model/README_job_model.md` | `docs/France_case/job_choice/README_job_model.md` |
| `scripts/Job_model/ACCEPTANCE_TESTS.md` | `docs/France_case/job_choice/ACCEPTANCE_TESTS.md` |
...
| Original | Mirror |
| --- | --- |
| `outputs/KEEP_RESULTS.md` | `docs/France_case/results/KEEP_RESULTS.md` |
| `notes/EUROMO_sys_france_2015.md` | `docs/France_case/notes/EUROMO_sys_france_2015.md` |
| `notes/R_REFERENCE_vs_PYTHON_SPECIFICATION.md` | `docs/France_case/notes/R_REFERENCE_vs_PYTHON_SPECIFICATION.md` |
...
6. `docs/France_case/euromod_reference/euromod_fr_2015_2017_input_output_reference.md`
...
1. `docs/France_case/RURO_ruro_occ_baseline_spec_v1.md`
2. `docs/France_case/RURO_ruro_occ_baseline_implementation_report_v1.md`
3. `docs/France_case/RURO_ruro_occ_M0_rebuild_command_plan_v1.md`
4. `docs/France_case/canary_reports/RURO_ruro_occ_M0_rebuild_canary_report_v1.md`

For the GSUR build chain (France), use the consolidated docs:

1. `docs/France_case/consolidated/RURO_GSUR_external_acquisition_consolidated_v1.md`
2. `docs/France_case/consolidated/RURO_GSUR_rebuild_consolidated_v1.md`
3. `docs/France_case/RURO_GSUR_rebuild_specification_v2_1.md` (governing spec, kept standalone)
