...
def write_report(results: dict, theta_dict: dict):
    ...
    A("| `Results/JMP_NC_pilot_vectorized_likelihood_equivalence_v2.md` | Created (this file) |")
    A("| `Results/JMP_NC_pilot_vectorized_likelihood_cleanup_validation_v1.md` | Created |")
    A("")
