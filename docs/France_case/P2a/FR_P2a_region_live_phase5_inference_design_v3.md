# FR P2a Region-Live — Phase-5 Inference Design — v3

**Mission:** JMP-M05 Stage D, remediation cycle 2 of 2 — household-clustered inference design
**Mode:** design only; no implementation, no computation, no commit
**Date:** 2026-07-31
**Target repository path:** `MNL/docs/France_case/P2a/FR_P2a_region_live_phase5_inference_design_v3.md`
**Supersedes:** `FR_P2a_region_live_phase5_inference_design_v2.md`, itself superseding v1. **Both are retained unedited** as the objects the Stage-C review and recheck cite. Neither is amended in place.
...
**Commit status:** UNCOMMITTED pending the T-7 micro-recheck and Stage-E manager acceptance
...
**Nothing in cycle 2 changes any recommended baseline, weakens any gate, or reopens any matter the recheck passed.** The correction moves the certified constant from `6.0423888115224145e-12` to `6.0424e-12`, a relative change of `1.8e-5`, in the direction of a marginally more permissive but correctly derived floor; T-7 remains gating.
