...
Generated on: 2026-05-11 19:05:45
...
|   +---[FILE] RURO_STIJN_COMPARISON_AND_ACTION_PLAN.md | size: 11.20 KB | ext: .md
|   +---[FILE] RURO_STIJN_COMPARISON_SECTOR_OPPORTUNITY_PLAN.md | size: 21.24 KB | ext: .md
...
|   \---[FILE] STIJN_vs_PYTHON_SPECIFICATION.md | size: 8.44 KB | ext: .md
+---[DIR] outputs/
|   +---[DIR] diagnostics/
|   |   +---[DIR] loc_by_dehde/
...
|   |   +---[FILE] enh_RURO_prep.py | size: 55.22 KB | ext: .py
...
+---[FILE] commands.txt | size: 3.73 KB | ext: .txt
...
+---[FILE] README.md | size: 8.65 KB | ext: .md
...
+---[FILE] TODO.md | size: 8.17 KB | ext: .md
