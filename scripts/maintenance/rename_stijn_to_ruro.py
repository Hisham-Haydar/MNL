...
SAFE_HAVENS: Set[Path] = {
    ...
    # The script itself contains 'stijn' in its replacement maps; if it ever
    # rewrote its own source the maps would collapse into identities.
    (REPO_ROOT / "scripts" / "maintenance" / "rename_stijn_to_ruro.py"),
}
